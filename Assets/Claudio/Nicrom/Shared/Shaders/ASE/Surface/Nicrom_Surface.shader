...
Shader "Nicrom/ASE/Surface"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _MRAO_ST;
			float4 _Normal_ST;
			float3 _CoverageColor;
			float3 _Color;
			float3 _EdgeHighlightColor;
			float3 _TriplanarColor;
			float _Smoothness;
			float _Metallic;
			float _CoverageSpace;
			float _CoverageNormalScale;
			float _CoverageFalloff;
			float _CoverageAmount;
			float _CoverageNormalBlend;
			float _Debug;
			float _NormalScale;
			float _CoverageSmoothness;
			float _CoverageTiling;
			float _TriplanarAlbedoIntensity;
			float _TriplanarTilingSpace;
			float _TriplanarTiling;
			float _EdgeHighlightSharpMax;
			float _EdgeHighlightSharpMin;
			float _TriplanarNormalScale;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_CurvatureMap = input.ase_texcoord7.xy * _CurvatureMap_ST.xy + _CurvatureMap_ST.zw;
				...
				float2 temp_cast_3 = (TriplanarTiling_F237_g9).xx;
				float4 triplanar78_g9 = TriplanarSampling78_g9( _TriplanarAlbedo, PositionWS, NormalWS, 1.0, temp_cast_3, 1.0, 0 );
				...
				float2 temp_cast_7 = (CoverageTiling19_g9).xx;
				float4 triplanar86_g9 = TriplanarSampling86_g9( _CoverageAlbedo, PositionWS, NormalWS, 1.0, temp_cast_7, 1.0, 0 );
				...
				float3 unpack44_g9 = UnpackNormalScale( tex2D( _Normal, uv_Normal ), _NormalScale );
				unpack44_g9.z = lerp( 1, unpack44_g9.z, saturate(_NormalScale) );
				float3 MainNormalTex48_g9 = unpack44_g9;
				float2 temp_cast_9 = (TriplanarTiling_F237_g9).xx;
				float3x3 ase_worldToTangent = float3x3( TangentWS, BitangentWS, NormalWS );
				float TriplanarNormalScale15_g9 = _TriplanarNormalScale;
				float3 triplanar35_g9 = TriplanarSampling35_g9( _TriplanarNormal, PositionWS, NormalWS, 1.0, temp_cast_9, TriplanarNormalScale15_g9, 0 );
				float3 tanTriplanarNormal35_g9 = mul( ase_worldToTangent, triplanar35_g9 );
				float3 TriplanarNormal38_g9 = tanTriplanarNormal35_g9;
				#ifdef _TRIPLANARPROJECTION_ON
				float3 staticSwitch181_g9 = BlendNormal( TriplanarNormal38_g9 , MainNormalTex48_g9 );
				#else
				...
				float CoverageNormalsMask41_g9 = pow( saturate( ( NormalWS.y + Coverage_Amount11_g9 ) ) , Coverage_Falloff23_g9 );
				...
				float2 temp_cast_10 = (CoverageTiling19_g9).xx;
				float CoverageNormalScale18_g9 = _CoverageNormalScale;
				float3 triplanar32_g9 = TriplanarSampling32_g9( _CoverageNormal, PositionWS, NormalWS, 1.0, temp_cast_10, CoverageNormalScale18_g9, 0 );
				float3 tanTriplanarNormal32_g9 = mul( ase_worldToTangent, triplanar32_g9 );
				float3 CoverageNormal39_g9 = tanTriplanarNormal32_g9;
				float3 lerpResult200_g9 = lerp( MainNormalWithTriplanar2287_g9 , BlendNormal( MainNormalWithTriplanar2287_g9 , CoverageNormal39_g9 ) , CoverageNormalsMask41_g9);
				#ifdef _COVERAGE_ON
				...
				float3 tanNormal52_g9 = staticSwitch199_g9;
				float3 worldNormal52_g9 = float3( dot( tanToWorld0, tanNormal52_g9 ), dot( tanToWorld1, tanNormal52_g9 ), dot( tanToWorld2, tanNormal52_g9 ) );
				float3 PixelNormal54_g9 = worldNormal52_g9;
				float WorldObjectSwitch55_g9 = _CoverageSpace;
				float3 lerpResult65_g9 = lerp( PixelNormal54_g9 , mul( GetWorldToObjectMatrix(), float4( PixelNormal54_g9 , 0.0 ) ).xyz , WorldObjectSwitch55_g9);
				...
				float2 uv_MRAO = input.ase_texcoord7.xy * _MRAO_ST.xy + _MRAO_ST.zw;
				...
				float3 BaseColor = localDebug263_g9.xyz;
				float3 Normal = staticSwitch199_g9;
				float3 Specular = 0.5;
				float Metallic = ( T_Metalic125_g9 * _Metallic );
				float Smoothness = staticSwitch232_g9;
				float Occlusion = lerpResult119_g9;
				float3 Emission = 0;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float CurvatureSharpnessMin176_g9 = _EdgeHighlightSharpMin;
				float CurvatureSharpnessMax177_g9 = _EdgeHighlightSharpMax;
				float2 uv_CurvatureMap = input.ase_texcoord3.xy * _CurvatureMap_ST.xy + _CurvatureMap_ST.zw;
				float T_Curvature148_g9 = tex2D( _CurvatureMap, uv_CurvatureMap ).r;
				float smoothstepResult135_g9 = smoothstep( CurvatureSharpnessMin176_g9 , CurvatureSharpnessMax177_g9 , T_Curvature148_g9);
				float EdgeMask140_g9 = smoothstepResult135_g9;
				float3 lerpResult147_g9 = lerp( MainColor171_g9 , CurvatureColor169_g9 , EdgeMask140_g9);
				...
				float4 triplanar78_g9 = TriplanarSampling78_g9( _TriplanarAlbedo, PositionWS, ase_normalWS, 1.0, temp_cast_3, 1.0, 0 );
				float3 TriplanarColor173_g9 = _TriplanarColor;
				float3 lerpResult134_g9 = lerp( TriplanarColor173_g9 , CurvatureColor169_g9 , EdgeMask140_g9);
				#ifdef _EDGEHIGHLIGHT_ON
				float3 staticSwitch155_g9 = lerpResult134_g9;
				...
				float CoverageTiling19_g9 = _CoverageTiling;
				float2 temp_cast_7 = (CoverageTiling19_g9).xx;
				float4 triplanar86_g9 = TriplanarSampling86_g9( _CoverageAlbedo, PositionWS, ase_normalWS, 1.0, temp_cast_7, 1.0, 0 );
				float3 CoverageColor75_g9 = _CoverageColor;
				float4 CoverageAlbedo100_g9 = ( triplanar86_g9 * float4( CoverageColor75_g9 , 0.0 ) );
				...
				float TriplanarNormalScale15_g9 = _TriplanarNormalScale;
				float3 triplanar35_g9 = TriplanarSampling35_g9( _TriplanarNormal, PositionWS, ase_normalWS, 1.0, temp_cast_9, TriplanarNormalScale15_g9, 0 );
				float3 tanTriplanarNormal35_g9 = mul( ase_worldToTangent, triplanar35_g9 );
				float3 TriplanarNormal38_g9 = tanTriplanarNormal35_g9;
				#ifdef _TRIPLANARPROJECTION_ON
				float3 staticSwitch181_g9 = BlendNormal( TriplanarNormal38_g9 , MainNormalTex48_g9 );
				...
				float2 temp_cast_10 = (CoverageTiling19_g9).xx;
				float CoverageNormalScale18_g9 = _CoverageNormalScale;
				float3 triplanar32_g9 = TriplanarSampling32_g9( _CoverageNormal, PositionWS, ase_normalWS, 1.0, temp_cast_10, CoverageNormalScale18_g9, 0 );
				float3 tanTriplanarNormal32_g9 = mul( ase_worldToTangent, triplanar32_g9 );
				float3 CoverageNormal39_g9 = tanTriplanarNormal32_g9;
				float3 lerpResult200_g9 = lerp( MainNormalWithTriplanar2287_g9 , BlendNormal( MainNormalWithTriplanar2287_g9 , CoverageNormal39_g9 ) , CoverageNormalsMask41_g9);
				#ifdef _COVERAGE_ON
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float CurvatureSharpnessMin176_g9 = _EdgeHighlightSharpMin;
				float CurvatureSharpnessMax177_g9 = _EdgeHighlightSharpMax;
				float2 uv_CurvatureMap = input.ase_texcoord1.xy * _CurvatureMap_ST.xy + _CurvatureMap_ST.zw;
				float T_Curvature148_g9 = tex2D( _CurvatureMap, uv_CurvatureMap ).r;
				float smoothstepResult135_g9 = smoothstep( CurvatureSharpnessMin176_g9 , CurvatureSharpnessMax177_g9 , T_Curvature148_g9);
				float EdgeMask140_g9 = smoothstepResult135_g9;
				float3 lerpResult147_g9 = lerp( MainColor171_g9 , CurvatureColor169_g9 , EdgeMask140_g9);
		...
		Pass
		{
						 ...
						 )
			{
				...
				float3x3 ase_worldToTangent = float3x3( TangentWS, BitangentWS, NormalWS );
				float TriplanarNormalScale15_g9 = _TriplanarNormalScale;
				float3 triplanar35_g9 = TriplanarSampling35_g9( _TriplanarNormal, PositionWS, NormalWS, 1.0, temp_cast_0, TriplanarNormalScale15_g9, 0 );
				float3 tanTriplanarNormal35_g9 = mul( ase_worldToTangent, triplanar35_g9 );
				float3 TriplanarNormal38_g9 = tanTriplanarNormal35_g9;
				#ifdef _TRIPLANARPROJECTION_ON
				float3 staticSwitch181_g9 = BlendNormal( TriplanarNormal38_g9 , MainNormalTex48_g9 );
				...
				float CoverageNormalScale18_g9 = _CoverageNormalScale;
				float3 triplanar32_g9 = TriplanarSampling32_g9( _CoverageNormal, PositionWS, NormalWS, 1.0, temp_cast_1, CoverageNormalScale18_g9, 0 );
				float3 tanTriplanarNormal32_g9 = mul( ase_worldToTangent, triplanar32_g9 );
				float3 CoverageNormal39_g9 = tanTriplanarNormal32_g9;
				float3 lerpResult200_g9 = lerp( MainNormalWithTriplanar2287_g9 , BlendNormal( MainNormalWithTriplanar2287_g9 , CoverageNormal39_g9 ) , CoverageNormalsMask41_g9);
				#ifdef _COVERAGE_ON
